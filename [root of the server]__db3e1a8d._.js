...
var AnalysisType = /*#__PURE__*/ function(AnalysisType) {
    AnalysisType["EXPLAIN"] = "explain";
    AnalysisType["FIND_BUGS"] = "find_bugs";
    AnalysisType["SUGGEST_IMPROVEMENTS"] = "suggest_improvements";
    return AnalysisType;
}(AnalysisType || {});
    ...
    try {
        ...
        if (!code_snippet || !analysis_type) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Missing required fields: code_snippet and analysis_type'
            }, {
                status: 400
            });
        }
        if (!Object.values(AnalysisType).includes(analysis_type)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid analysis_type provided.'
            }, {
                status: 400
            });
        }
